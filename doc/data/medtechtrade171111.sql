...
CREATE TABLE `busqueda` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `palabras_busqueda` varchar(255) DEFAULT NULL,
...
insert  into `busqueda`(id,palabras_busqueda,modelo,fabricante,categoria_id,anio_inicio,anio_fin,precio_inicio,precio_fin,usuario_id,active) values (3,'equ','','',-1,-1,-1,0,-1,6,1),(4,'ex',NULL,NULL,-1,-1,-1,-1,-1,6,1),(6,'ex',NULL,NULL,-1,-1,-1,-1,-1,6,0),(7,'exxxxx','','',-1,-1,-1,-1,-1,6,0),(8,'sdfsfs','ds','',-1,-1,-1,-1,-1,6,0),(9,'sdfdsfsssssssss','','',-1,-1,-1,-1,-1,6,0),(10,'test1 mod','','',-1,-1,-1,-1,-1,6,0),(11,'equipo','','',-1,-1,-1,-1,-1,6,1),(12,'equi','sam','s',-1,-1,-1,-1,-1,6,1),(33,'test','','',-1,-1,-1,-1,-1,6,0),(34,'test t','','',-1,-1,-1,-1,-1,6,1),(35,'test','','',-1,-1,-1,-1,-1,6,1),(36,'testing','','',-1,-1,-1,-1,-1,6,0),(37,'eco','','',-1,-1,-1,-1,-1,3,1),(38,'equ','','',-1,-1,-1,-1,-1,6,1);
...
insert  into `equipo`(id,nombre,precioventa,preciocompra,categoria_id,estadoequipo_id,publicacionEquipo_id,usuario_id,fabricantes_id,tag,moneda_id,paises_id,calidad,cantidad,modelo,fechafabricacion,documento,sourceDocumento,pesoEstimado,size,ancho,alto,sizeCaja,active,views,topofers,publishdate,slug) values (2,'Equipo 1',12,12,148,1,2,3,2,'sas',1,1,'buena',122,'23123','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,79,0,NULL,''),(3,'equipo 2',123,111,148,2,2,3,2,'kusa,kusa',1,1,'muy mala',123,'123we','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,198,0,NULL,'equipo-2'),(4,'equipo 3',125,140,151,1,2,5,2,'1245',3,1,'buena',145,'1455214','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,313,0,NULL,'equipo-3'),(5,'equipo 4',1234,12,162,1,2,3,2,'qwq',1,1,'muy buena',12,'2122','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,508,1,NULL,'equipo-4'),(6,'test tsfs',120,240,150,2,2,6,2,'sssss',2,1,'Alta calidad',5,'s','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,702,0,NULL,'test-tsfs'),(9,'prueba equivo',15,1285,151,2,2,6,2,'',1,1,'Buena Calidad',10,'120vb','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,271,0,NULL,'prueba-equivo'),(10,'test 2 x',9,1258,152,2,2,6,2,'dgdfgdgfd',1,1,'Buena Calidad',15,'xxxxxxxxxxxxxxx','0000-00-00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,28,1,NULL,'test-2-x'),(11,'test tsfs2',5,245,150,1,2,6,2,'sfsf',1,1,'Buena Calidad',35,'xxxxxxxxxxxxxxx','2011-03-20',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,16,0,NULL,'test-tsfs2'),(12,'test tsfs3',14,654,159,1,4,6,2,'sgadgsg',2,1,'Buena Calidad',10,'tst','2011-03-15',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,51,0,NULL,'test-tsfs3'),(13,'stereo xxxx',58,958,150,1,2,6,2,'sdsssssssssssssss',1,1,'Buena Calidad',25,'sfs','2011-03-17',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,18,1,NULL,'stereo-xxxx'),(14,'electrocardiograma',0,915,151,2,1,6,2,'Equipo de Electro',2,1,'Excelente',10,'varuadis','2011-03-24',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,3,0,NULL,'electrocardiograma'),(15,'mamografo',15,250,151,1,1,3,2,'t',3,1,'muy buena',15,'ste','2017-05-02',NULL,NULL,'109.20','11.98','38.00','24.65','18.20',1,NULL,0,NULL,'mamografo'),(16,'ecografo',150,250,157,2,1,3,2,'test',3,1,'muy buen',12,'test','2017-05-24',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL,'ecografo'),(17,'ecografo',150,250,151,1,1,3,2,'123',2,1,'muy buena',15,'test','2017-05-29',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL,'ecografo-1'),(18,'ecografo',150,250,154,1,1,3,2,'test',3,1,'testing',1200,'sts',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL,'ecografo-2'),(19,'ecografo professional',150,250,154,1,2,3,2,'test',3,1,'testing',1200,'sts','2009-05-25',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL,'ecografo-12'),(20,'tomografo',150,124,157,1,2,3,2,'',3,1,'muy buena',14,'basico','2005-07-04',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,9,0,NULL,'tomografo'),(21,'tomografo A2',150,124,157,1,2,3,2,'',3,1,'muy buena',14,'basico','2005-07-04',NULL,NULL,NULL,'15.20','15.80','29.10','120.40',1,NULL,0,NULL,'tomografo-a2'),(22,'testttttttttttttt',150,240,150,2,2,3,2,'test',2,1,'muy buena',15,'sam','2017-05-28',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,6,0,NULL,'testttttttttttttt'),(23,'tester',17.21,90.1,150,1,2,3,2,'',3,1,'muy buena',15,'mx-58','2017-05-02',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,81,0,NULL,'tester'),(24,'endoscopio',150.5,198.8,155,1,2,3,2,'',2,1,'muy buena',125,'mx-58','2017-05-30',NULL,NULL,NULL,'11.00','11.00','11.00','11.00',1,NULL,0,NULL,'endoscopio'),(25,'respirator 1',0,150,154,1,1,6,5,'test',2,1,'buena',0,'XTX','2017-05-09',NULL,NULL,'14.00','150.00','147.00','98.00','154.00',1,NULL,0,NULL,'respirator-1'),(26,'analizador  sangre',0,170,148,1,1,6,6,'test',3,1,'buena',5,'xxxx','2008-05-18',NULL,NULL,'150.20','52.00','41.00','400.00','400.00',1,NULL,0,NULL,'analizador');
...
insert  into `fabricantes`(id,nombre,active) values (2,'Samsung',1),(4,'fabricante',0),(5,'LG x',1),(6,'General Electric',1);
...
insert  into `imagen`(id,equipo_id,nombre,thumb,imagen,published,descripcion,order,active) values (1,13,'imagen1',NULL,'1254.png',1,NULL,1,1),(2,13,'imagen2',NULL,'1234.png',1,NULL,1,1),(4,14,'testttttttttttttt',NULL,'292a_t.jpg',0,'testttttttttttttttttttt',1,1),(5,14,'terts',NULL,'292c.jpg',0,'tsafaaaaa',1,1),(6,14,'sdafsdds',NULL,'device-00.png',0,'fsdfsdfds',1,0),(8,10,'dfsaaaaaaaaaaa',NULL,'jpg_catolica_escudo.jpg',0,'saaaaaaaaaaaaaaaaaa',1,1),(9,10,'imagen principal',NULL,'no_imagec.jpg',0,'descripcion de la imagen de preuba',1,1),(10,10,'testttttttttttttttttttttttt','icono-email.jpg','icono-email.jpg',0,'test',1,1),(11,10,'imagen_test','errror.jpg','errror.jpg',0,'test',5,1),(12,10,'imagen_preub','icono-email.jpg','icono-email.jpg',0,'test',6,1);
...
insert  into `moneda`(id,nombre,simbolo,prefijo,active,cambio) values (1,'franco suizo','€',NULL,0,NULL),(2,'dolar','$',NULL,1,NULL),(3,'soles','s/',NULL,1,NULL),(4,'penike','*',NULL,1,NULL);
...
insert  into `paises`(id,nombre,code,active) values (1,'Peru','PE',1),(2,'ecuador','EC',0);
...
insert  into `pregunta`(id,categoriapregunta_id,equipo_id,usuario_id,asunto,formulacion,fechaFormulacion,fechaRespuesta,respuesta,copiaEmail,active,estado) values (1,1,4,6,'testin','testing\r\nacerca del producto\r\n4\r\nsaludos','2011-09-26 13:08:38','2011-10-13 15:10:43','test',1,1,1),(2,1,4,6,'testing 1','teststttttttttttttttttttt','2011-10-13 10:41:53','2011-10-13 15:10:22','test',0,1,1),(3,1,4,6,'testing 1','teststttttttttttttttttttt','2011-09-26 00:00:00',NULL,NULL,0,1,0);
...
insert  into `reserva`(id,equipo_id,usuario_id,fechagrabacion,order,active,tipo_reserva_id) values (3,4,6,'2011-09-28 16:25:14',NULL,0,2),(5,13,6,'2011-09-28 16:56:43',NULL,1,2),(6,4,7,'2011-09-28 12:34:08',NULL,1,2),(7,4,3,'2011-09-28 21:33:46',NULL,1,2),(8,11,6,'2011-09-30 15:34:25',NULL,1,2),(9,6,6,'2011-10-06 21:54:46',NULL,1,2),(10,9,6,'2011-10-12 15:25:35',NULL,1,1),(11,23,3,'2011-10-12 22:24:28',NULL,1,2),(12,23,3,'2011-10-12 22:25:14',NULL,1,1);
...
insert  into `usuario`(id,nombre,apellido,email,login,clave,tipousuario_id,sendemail,fecharegistro,ultimavisita,activacion,active,direccion,codpostal,ciudad,institucion,paises_id,direccion1,direccion2,tratamiento,telefono,fax,fechamodificacion) values (3,'Luis alberto','mayta mamani','slovacusx@gmail.com','admin','sha1$87711$488758631b7e41e578f9b4b95d96cecfa288f696',1,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,'mi casa','1414','Lima','master',1,NULL,NULL,NULL,NULL,NULL,NULL),(4,'Luis alberto','mayta mamani','slovacus1@gmail.com','kusanagi','sha1$21ee2$9be1a234e6a93bcb218c56189d70b6a0be2d7d8b',3,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,'mi casa','1414','Lima','dsdfsd',1,NULL,NULL,NULL,NULL,NULL,NULL),(5,'matias','franci','mfranci@gmail.com','mfranci','sha1$9d02a$de595b6b2d2bd7d9f3a8ece6f9813e7553fc8aa6',3,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,'mi casa','1414','lima','dsfsdfs',1,NULL,NULL,NULL,NULL,NULL,NULL),(6,'Luis alberto','mayta mamani','slovacus@gmail.com','usuario','sha1$87711$488758631b7e41e578f9b4b95d96cecfa288f696',3,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,'home','1414','Lima','St Group',1,NULL,NULL,1,'','',NULL),(7,'teresa','chunga ','tj.chunga@gmail.com','tchunga','sha1$2599c$917f9e211f5f06b9f52739bb7891de9274c6a02e',3,NULL,'2011-09-23 15:24:11','2011-09-23 15:24:11',NULL,1,'-','-','Lima','st',1,NULL,NULL,NULL,NULL,NULL,NULL),(11,'teresa','chunga','tere_chunga@hotmail.com','tjche','sha1$2599c$917f9e211f5f06b9f52739bb7891de9274c6a02e',2,NULL,'0000-00-00 00:00:00','0000-00-00 00:00:00',NULL,1,'pando','lima 16','lima','sx',1,NULL,NULL,NULL,NULL,NULL,NULL);
