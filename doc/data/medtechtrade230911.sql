...
insert  into `equipo`(`id`,`nombre`,`precioventa`,`preciocompra`,`categoria_id`,`estadoequipo_id`,`publicacionEquipo_id`,`usuario_id`,`fabricantes_id`,`tag`,`moneda_id`,`paises_id`,`calidad`,`cantidad`,`modelo`,`fechafabricacion`,`documento`,`sourceDocumento`,`pesoEstimado`,`size`,`ancho`,`alto`,`sizeCaja`,`active`,`views`,`topofers`,`publishdate`) values (2,'Equipo 1',12,12,148,1,2,3,2,'sas',1,1,'buena',122,'23123','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,0,79,0,NULL),(3,'equipo 2',123,111,148,2,1,3,2,'kusa,kusa',1,1,'muy mala',123,'123we','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,100,0,NULL),(4,'equipo 3',125,140,151,1,2,5,2,'1245',1,1,'buena',145,'1455214','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,240,0,NULL),(5,'equipo 4',1234,12,162,1,2,3,2,'qwq',1,1,'muy buena',12,'2122','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,389,1,NULL),(6,'test tsfs',120,240,150,2,2,6,2,'sssss',2,1,'Alta calidad',5,'s','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,671,0,NULL),(9,'prueba equivo',0,1285,151,2,1,6,2,'',1,1,'Buena Calidad',10,'120vb','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,95,0,NULL),(10,'test 2 x',0,1258,152,2,1,6,2,'dgdfgdgfd',1,1,'Buena Calidad',15,'xxxxxxxxxxxxxxx','0000-00-00 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,2,1,NULL),(11,'test tsfs2',0,245,150,1,1,6,2,'sfsf',1,1,'Buena Calidad',35,'xxxxxxxxxxxxxxx','2015-03-20 17:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL),(12,'test tsfs3',0,654,159,1,1,6,2,'sgadgsg',2,1,'Buena Calidad',10,'tst','2023-03-20 17:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,0,NULL),(13,'stereo xxxx',0,958,150,1,1,6,2,'sdsssssssssssssss',1,1,'Buena Calidad',25,'sfs','2011-03-17 00:00:00',NULL,NULL,NULL,NULL,NULL,NULL,NULL,1,NULL,1,NULL);
...
insert  into `estadooperacion`(`id`,`nombre`,`active`) values (1,'Pendiente Pago',1),(2,'Vendidos',1),(3,'Reservado',1);
...
insert  into `favorito_equipo_usuario`(`id`,`equipo_id`,`usuario_id`,`fechagrabacion`,`order`,`active`) values (1,13,6,'2011-09-23 12:42:16',1,1),(2,13,5,'2011-09-23 12:42:59',1,1);
...
insert  into `moneda`(`id`,`nombre`,`simbolo`,`prefijo`,`active`) values (1,'franco suizo','c',NULL,1),(2,'dolar','$',NULL,1),(3,'soles','s/',NULL,1);
...
insert  into `operacion`(`id`,`estadooperacion_id`,`fecha`,`usuario_id`,`fechainicio`,`fechapago`) values (1,2,'2011-09-22 11:28:37',6,'2011-09-22 11:28:37','2011-09-22 11:28:37');
...
insert  into `operacion_has_equipo`(`operacion_id`,`equipo_id`,`id`,`precio`,`cantidad`,`equipo_has_formapago_id`) values (1,13,4,158,2,1);
