...
//        $pdfData = $pdf->render();
        ...
        $page->drawText(
                ucwords($this->_translate->translate('ficha del equipo')), 85, 650);
        /* end ficha de equipo */
        ...
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('condicion de calidad')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('offerer name')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('offerer city')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('amount of equipment')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('descripcion')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
        $pdfX -= $aumento;
        /* cabecera */
        $page->drawText(ucwords($this->_translate->translate('selling price')), $pdfYCabecera, $pdfX);
        /* valor del manufacturer */
        $page->drawText('aca va el manufacturer', $pdfY, $pdfX);
        /**/
