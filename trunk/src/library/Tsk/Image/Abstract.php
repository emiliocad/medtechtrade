...
abstract class Tsk_Image_Abstract
    ...
    public function resizeLimit( $newFile , $newWidth , $newHeight )
        {
        $percent = ($this->_width > $newWidth) ? (($newWidth * 100) / $this->_width)
                    : 100;
    ...
    public function crop( $newFile , $newWidth , $newHeight , $resize = true ,
        ...
        $this->_crop( $newFile , $resizeWidth , $resizeHeight , $newWidth ,
                      $newHeight , $cropX , $cropY , $resize );
        }
