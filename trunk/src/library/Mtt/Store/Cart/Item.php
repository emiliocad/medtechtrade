...
class Mtt_Store_Cart_Item
    ...
    public function __construct( Mtt_Models_Bussines_Equipo $product = null ,
                                 $qty = null )
        {
    ...
    public function setProduct( Mtt_Models_Bussines_Equipo $product )
        {
        $this->_product = $product;
        $this->_calculateImporte();
        }
