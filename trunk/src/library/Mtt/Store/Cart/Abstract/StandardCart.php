...
class Mtt_Store_Cart_Abstract_StandardCart
        extends Mtt_Store_Cart_Abstract
    {
    ...
    public function reset( $resetDatabase = false )
        {
        $this->_contents = new Mtt_Store_Cart_Item_Collection();
        $this->_total = 0;
        $this->_weight = 0;
        $sessionData = Zend_Registry::getInstance()->get( 'Mtt' );
    ...
    public function addCart( Mtt_Store_Cart_Item $item )
        {
